...
{
    public class TipoUnidadeNegocioTipoEntidadeVinculoService : BaseService<TipoUnidadeNegocioTipoEntidadeVinculo>, ITipoUnidadeNegocioTipoEntidadeVinculoService
    {
        public TipoUnidadeNegocioTipoEntidadeVinculoService(ITipoUnidadeNegocioTipoEntidadeVinculoRepository repository, TipoUnidadeNegocioTipoEntidadeVinculoValidator validator) : base(repository, validator)
        {
        }
    }
}
