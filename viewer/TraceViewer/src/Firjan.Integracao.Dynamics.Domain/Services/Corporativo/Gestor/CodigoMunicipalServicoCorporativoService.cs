...
{
    public class CodigoMunicipalServicoCorporativoService : BaseService<CodigoMunicipalServicoCorporativo>, ICodigoMunicipalServicoCorporativoService
    {
        public CodigoMunicipalServicoCorporativoService(ICodigoMunicipalServicoCorporativoRepository repository, CodigoMunicipalServicoCorporativoValidator validator) : base(repository, validator) { }
    }
}
